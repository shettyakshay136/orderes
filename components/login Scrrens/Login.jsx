  ...
  return (
    <View style={{backgroundColor: '#eaf0ff',height: '100%',display: 'flex',gap: 50,}}>
        ...
        <View style={[{ padding:40 , gap:20}]}>
            ...
            <TouchableOpacity onPress={() => navigation.navigate('Loginsuss')} style={[{ backgroundColor: "#ff8e00" , marginTop:25 , height: 43 , borderRadius: 50, alignItems: 'center', justifyContent:'center', display:'flex' }]}>
